...
$formproc->AddRecipient('nikola@scalateam.com'); //<<---Put your email address here
...
<legend>Pošaljite poruku</legend>
...
<div class='short_explanation'>* obavezna polja</div>
...
<div class='container'>
    ...
    <label for='name' ><font color="#000">Vase ime*:</font> </label><br/>
...
<div class='container'>
    ...
    <label for='email' ><font color="#000">Vasa e-mail adresa*:</font></label><br/>
...
<div class='container'>
    ...
    <label for='tema' ><font color="#000">Tema poruke*:</font> </label><br/>
...
<div class='container'>
    ...
    <label for='message' ><font color="#000">Poruka:</font></label><br/>
